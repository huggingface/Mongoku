...
export class DocumentComponent implements OnInit {
  ...
  remove() {
    this.mongodb.remove(this.server, this.database, this.collection, this.document).subscribe((res: any) => {
      this.item = null;
      this.router.navigate(["servers", this.server, "databases", this.database, "collections", this.collection]);
    });
  }
}
